...
import { ChangeDetectorStatus } from '@angular/core/src/change_detection/change_detection';
...
@Component({
    ...
    //changeDetection: ChangeDetectorStatus.CheckOnce
...
export class RoleComponent implements OnInit {
    ...
    constructor(
        ...
        this.cardTitle = this.id == 0 ? "New Role" : "Edit Role";
